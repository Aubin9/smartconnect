        ...
        {cells.map((cell) => {
          ...
          return (
            <CircleMarker
              ...
              pathOptions={{
                color: colorFor(probability),
                fillColor: colorFor(probability),
                fillOpacity: 0.55,
              }}
            ...
            >
              <Popup>
                <div className="min-w-56 space-y-2">
                  ...
                  <p>
                    RSRP: <strong>{cell.latestKpi?.rsrp ?? "N/A"} dBm</strong>
                  </p>
                  <p>
                    SINR: <strong>{cell.latestKpi?.sinr ?? "N/A"} dB</strong>
                  </p>
                  <p>
                    PRB:{" "}
                    <strong>{cell.latestKpi?.prbUtilization ?? "N/A"}%</strong>
                  </p>
                  <p>
                    Throughput P50:{" "}
                    <strong>
                      {cell.latestKpi?.throughput50th ?? "N/A"} Mbps
                    </strong>
                  </p>
                  <p>
                  ...
                  <Button
                    ...
                    className="w-full"
                    onClick={() =>
                      alert(`Alert simulation queued for ${cell.cellId}`)
                    }
                  >
                    Trigger Alert
                  </Button>
