  ...
  const cards = [
    {
      ...
      value: formatCompact(stats.activeSubscribers),
      detail: "↑ 3.4% from yesterday",
    },
    {
      title: "Current Congested Cells",
      value: String(stats.currentCongestedCells),
      detail: "↓ 12 from 1hr ago",
    },
    {
      title: "Avg Trust Score",
      value: stats.avgTrustScore.toFixed(1),
      detail: "↑ 0.3 nightly batch",
    },
    {
      title: "Today's Credits Disbursed",
      value: formatXaf(stats.creditsDisbursedToday),
      detail: "PNQM + insurance payouts",
    },
    {
      title: "Pending Alerts",
      value: String(stats.pendingAlerts),
      detail: "Click bell to review",
    },
  ];
      ...
      {cards.map((card, index) => {
        ...
        return (
          <Card key={card.title} className="overflow-hidden p-0">
            <div
              className={`bg-gradient-to-br ${gradients[index]} p-5 text-white`}
            >
